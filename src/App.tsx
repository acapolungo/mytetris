    ...
    <div className="mx-auto h-screen flex justify-center items-center bg-gradient-to-br from-purplebg to-cyanbg">
      ...
      <div className="w-[35rem] h-[42rem] p-[1.75rem] bg-gradient-to-br from-magenta via-purple to-cyan flex justify-between drop-shadow-xl">
        <section className="w-[19.25rem] h-[100%] bg-greybg rounded-md grid grid-cols-11 grid-rows-22 text-white">
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-s-yellow"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-s-yellow"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-s-yellow"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-s-yellow"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-s-yellow"></div>
          ...
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-t-orange"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-t-orange"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-t-orange"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-t-orange"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-t-orange"></div>
          ...
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-o-purple"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-o-purple"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-o-purple"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-o-purple"></div>
          <div className="w-[1.75rem] h-[1.75rem] flex justify-center items-center border-redbg border-[0.1rem] rounded bg-o-purple"></div>
          ...
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-l-blue"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-l-blue"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-l-blue"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-l-blue"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-l-blue"></div>
          ...
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-i-red"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-i-red"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-i-red"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-i-red"></div>
          <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-i-red"></div>
          ...
          <section className="w-[100%]">
            ...
            <div className="w-[100%] h-[7rem] bg-greybg rounded-md flex flex-wrap justify-center items-center content-center">
              <div className="w-[100%] flex justify-center">
                <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-t-orange"></div>
              </div>
              <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-t-orange"></div>
              <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-t-orange"></div>
              <div className="w-[1.75rem] h-[1.75rem] border-redbg border-[0.1rem] rounded bg-t-orange"></div>
